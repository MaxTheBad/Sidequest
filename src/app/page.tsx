            ...
            <article key={q.id} className={`quest-card w-full bg-white border border-slate-200 shadow-[0_14px_40px_rgba(15,23,42,0.08)] overflow-hidden ${feedViewMode === "list" ? "rounded-none sm:rounded-[1.75rem] h-[calc(100svh-10.75rem)] sm:h-auto flex flex-col" : "rounded-[2rem]"}`}>
              ...
              {feedViewMode === "list" ? (
                ...
                <div className="px-4 py-3 bg-white">
                  <div className={`grid w-full items-center ${userId !== q.creator_id ? "grid-cols-5" : "grid-cols-4"}`}>
                    {userId !== q.creator_id ? (
                      <button
                        className="justify-self-start inline-flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-sm font-semibold text-slate-900 transition hover:opacity-80"
                    ...
                    <button className="justify-self-center inline-flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-sm font-medium text-slate-900 transition hover:opacity-80" aria-label="Comment" title="Comment" onClick={() => {
                    ...
                    <button className="justify-self-center inline-flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-sm font-medium text-slate-900 transition hover:opacity-80" aria-label="Direct message" title="Direct message" onClick={() => {
                    ...
                    <button className="justify-self-end inline-flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-sm font-medium text-slate-900 transition hover:opacity-80" aria-label="Share" title="Share" onClick={() => void shareQuest(q)}>
                      <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                        <path d="M12 5v14" />
