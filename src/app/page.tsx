                  ...
                  <>
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:gap-6">
                      <label className="flex gap-2 items-start leading-5 text-sm sm:flex-1">
                        ...
                        <span>I accept the <a href="/terms" target="_blank" rel="noreferrer" className="underline">Terms</a> and acknowledge the <a href="/privacy" target="_blank" rel="noreferrer" className="underline">Privacy Policy</a>.</span>
                      </label>
                      <label className="flex gap-2 items-start leading-5 text-sm sm:flex-1">
