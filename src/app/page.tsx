    ...
    <main className="min-h-screen bg-transparent">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-50 bg-black/45 flex items-end sm:items-center justify-center p-2 sm:p-4 overflow-y-auto overflow-x-hidden">
          <div className="w-[calc(100vw-1rem)] sm:w-full sm:max-w-xl rounded-2xl sm:rounded-2xl bg-white border sm:border p-3 sm:p-4 space-y-2.5 h-[92vh] sm:h-auto sm:max-h-[92vh] overflow-y-auto overflow-x-hidden my-0 sm:my-auto pb-28 md:pb-4">
