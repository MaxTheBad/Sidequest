            ...
            <article key={q.id} className="quest-card w-full rounded-[2rem] bg-white border border-slate-200 shadow-[0_14px_40px_rgba(15,23,42,0.08)] overflow-hidden">
              ...
              <div className="p-3 sm:p-4 space-y-3 flex h-full flex-col">
                ...
                <div className={`grid w-full items-center mt-1 ${userId !== q.creator_id ? "grid-cols-4" : "grid-cols-3"}`}>
                  {userId !== q.creator_id ? (
                    <button
                      className="justify-self-start inline-flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-sm font-semibold text-[color:var(--foreground)] dark:text-white transition hover:opacity-80"
                  ...
                  <button className="justify-self-center inline-flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-sm font-medium text-[color:var(--foreground)] dark:text-white transition hover:opacity-80" aria-label="Direct message" title="Direct message" onClick={() => {
                  ...
                  <button className="justify-self-end inline-flex h-10 w-10 items-center justify-center rounded-full bg-transparent text-sm font-medium text-[color:var(--foreground)] dark:text-white transition hover:opacity-80" aria-label={bookmarkedQuestIds.includes(q.id) ? "Saved" : "Save"} title={bookmarkedQuestIds.includes(q.id) ? "Saved" : "Save"} onClick={() => void toggleBookmark(q.id)}>
